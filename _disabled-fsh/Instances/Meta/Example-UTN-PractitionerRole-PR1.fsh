Instance: Example-ENRICH-PractitionerRole-PR1
InstanceOf: ENRICHPractitionerRole
Usage: #example
Description: "Example ENRICH PractitionerRole PR1"

* meta.profile = "https://fhir.kbv.de/StructureDefinition/KBV_PR_Base_PractitionerRole"
* practitioner = Reference(Example-ENRICH-Practitioner-PR1)
...
* healthcareService = Reference(Example-ENRICH-HealthcareService-Charite)