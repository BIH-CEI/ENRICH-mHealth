Instance: Example-ENRICH-PractitionerRole-PR2
InstanceOf: ENRICHPractitionerRole
Usage: #example
Description: "Example ENRICH PractitionerRole PR 2"

* meta.profile = "https://fhir.kbv.de/StructureDefinition/KBV_PR_Base_PractitionerRole"
* practitioner = Reference(Example-ENRICH-Practitioner-PR2)
...
* healthcareService = Reference(Example-ENRICH-Teleconsultation-Service-Wuerzburg)