Instance: Example-ENRICH-Consent-Forschungsvorhaben
InstanceOf: ENRICHConsent
Usage: #example
...
* patient = Reference(Example-ENRICH-Patient)
* dateTime = "2024-07-24"
...
Instance: Example-ENRICH-Consent-DocumentReference-Forschungsvorhaben
InstanceOf: ENRICHDocumentReference
Usage: #example
...
Instance: Example-ENRICH-Consent-Provenance-Forschungsvorhaben
...
* target = Reference(EnrichConsentForschungsvorhaben)
* recorded = "2024-07-24T09:00:00Z"
* location = Reference(ENRICHLocation)
* agent.who.display = "Klinikum Würzburg"
* entity.what = Reference(EnrichConsentDocumentReferenceForschungsvorhaben)
...
* signature.who = Reference(Example-ENRICH-Patient)


Instance: ENRICHLocation
InstanceOf: Location
Description: "Example location for ENRICH"
* name = "Berlin"
