Instance: Example-ENRICH-Consent-Videosprechstunde
...
Instance: Example-ENRICH-Consent-DocumentReference-Videosprechstunde
...
Instance: Example-ENRICH-Consent-Provenance-Videosprechstunde
...
* target = Reference(EnrichConsentVideosprechstunde)
* recorded = "2024-07-24T09:00:00Z"
* location = Reference(ENRICHLocation)
* agent.who.display = "Klinikum Würzburg"
* entity.what = Reference(EnrichConsentDocumentReferenceVideosprechstunde)
